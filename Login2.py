...
class SignIn:
    def __init__(self, container, home, disconnected_home, client_statue, callback_signin,
                 callback_initiate_register_ui):
    ...
    def create_ui(self):
        ...
        self._login_text = CTkLabel(master=self._signin_window, text="Sign in",
        ...
        self._username_text = CTkLabel(master=self._signin_window, text="Username", font=('Calibri', 15)).place(x=465,
                                                                                                                y=120)
        ...
        self._btn_password_visible = CTkButton(master=self._signin_window, image=self._close_eye_image, text="",
                                               hover=False,
        ...
        self._btn_register = CTkButton(self._signin_window, text="Register", height=30, width=80, text_color="white",
                                       hover_color="#4185D0",
    ...
    def on_click_register(self):
        ...
        if self._register is not None:
            ...
            self._register = Register(self._container, self._disconnected_home, self._client_statue,
                                      self.callback_client_register, self.initiate_existing_ui)
...
class Register:
    ...
    def create_ui(self):
        ...
        self._login_text = CTkLabel(master=self._register_window, text="Register",
                                    font=('Calibri', 50, "bold", "underline"))
        self._login_text.place(x=415, y=50)

        self._username_entry = CTkEntry(self._register_window, placeholder_text="enter username")
        self._username_entry.place(x=430, y=150)
        self._username_text = CTkLabel(master=self._register_window, text="Username", font=('Calibri', 15)).place(x=465,
                                                                                                                  y=120)
        ...
        self._btn_password_visible = CTkButton(master=self._register_window, image=self._close_eye_image, text="",
                                               hover=False, text_color="white", width=30, height=30,
                                               fg_color="transparent", command=self.toggle_password_visibility)
        self._btn_password_visible.place(x=570, y=209)
        ...
        self._btn_register = CTkButton(self._register_window, text="Register", font=("Calibri", 15),
                                       command=self.on_click_register, height=30, width=150)
        self._btn_register.place(x=425, y=310)
        self._default_items_checkbox = CTkCheckBox(master=self._register_window, text="Add default items",
                                                   font=("Calibri", 17))
        self._default_items_checkbox.place(x=585, y=315)
        self._default_items_checkbox.select()

        self._btn_back = CTkButton(self._register_window, text="Back", height=30, width=80, text_color="white",
                                   hover_color="#4185D0", font=("Calibri", 17), fg_color="#C850C0",
                                   command=self.on_click_back)
        self._btn_back.place(x=915, y=10)

        self._btn_signin = CTkButton(self._register_window, text="Sign in", height=30, width=80, text_color="white",
                                     hover_color="#4185D0",
