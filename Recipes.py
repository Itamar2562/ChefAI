...
class Recipes:
    ...
    def create_ui(self):
        ...
        self._headline=CTkLabel(master=self._recipes_main_window, text="Recipes", font=('Calibri', 50,"bold","underline"), text_color="#5B5FD9")
    ...
    def on_click_cook(self,data):
        ...
        btn_save=CTkButton(scrollable_frame, text="Save", height=30, width=80, text_color="white",hover_color="#4185D0", font=("Calibri", 17), fg_color="#C850C0",command=lambda recipe=data: save_to_pdf(recipe))
