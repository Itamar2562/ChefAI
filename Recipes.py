...
class Recipes(CTkFrame):
    def __init__(self, container, home, client_statue,callback_receive_msg,callback_configure_make_btn):
        ...
        self._download_icon=CTkImage(Image.open(r"Images/download_icon.png"),size=(50,50))
    ...
    def on_click_back(self):
        def on_click_yes():
            ...
            self._home_window.update_idletasks()

        def on_click_no():
            self.on_click_destroy_specific_frames()
        self.on_click_destroy_specific_frames()
        self._specific_frame=CTkFrame(self,border_width=3,border_color="blue",height=200,width=300)
    ...
    def receive_massage(self):
        try:
            ...
            if data[0]['name']=="no available recipes":
                self.create_error_frame()
                return
            self.create_recipes_frame()
            self.add_recipes(data)
    ...
    def add_recipes(self,data,index=0):
        ...
        current_frame=CTkFrame(master=self._recipes_scrollable_window,width=200,
                               height=100,border_width=3,border_color="blue",corner_radius=15)
        ...
        cook_btn=CTkButton(master=current_frame,text="Cook",fg_color="cyan",text_color="black",
                           command=lambda user_data=d:self.on_click_cook(user_data))
        cook_btn.place(x=600,y=50)
        nutrition_btn=CTkButton(master=current_frame,text="Nutrition",fg_color="cyan",text_color="black",
    ...
    def on_click_nutrition(self,data):
        self.on_click_destroy_specific_frames()
        self._specific_frame=CTkFrame(self, width=750,border_width=3, border_color="blue")
        ...
        self._specific_frame.place(x=200, y=130)
