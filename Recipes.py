...
from WidgetUtils import DraggableFrame
...
class Recipes:
    ...
    def on_click_back(self):
        ...
        def on_click_no():
            self.on_click_destroy_specific_frame()
        self.on_click_destroy_specific_frame()
        self._specific_frame=DraggableFrame(self._recipes_main_window,border_width=3,border_color="blue",height=200,width=300)
    ...
    def add_recipes(self,data):
        ...
        for d in data:
            ...
            headline=CTkLabel(master=current_frame,text=d['name'], font=('Calibri',20,"bold","underline"),wraplength=500)
    ...
    def on_click_cook(self,data):
        self.on_click_destroy_specific_frame()
        self._specific_frame=DraggableFrame(self._recipes_main_window)
    ...
    def on_click_nutrition(self,data):
        self.on_click_destroy_specific_frame()
        self._specific_frame=DraggableFrame(self._recipes_main_window, width=750,border_width=3, border_color="blue")
